...
var NewImprovedWindow = function (props) {
    ...
    var _f = useState(false), isBlocked = _f[0], setIsBlocked = _f[1];
    ...
    if (center) {
        ...
        mutFeatures.width = (mutFeatures === void 0 ? void 0 : mutFeatures.width) ? mutFeatures.width : 600;
        mutFeatures.height = (mutFeatures === void 0 ? void 0 : mutFeatures.height) ? mutFeatures.height : 640;
        if (center === "parent") {
                ...
                if (rules) {
                    ...
                    Array.from(styleSheet.cssRules).forEach(function (cssRule) {
                        ...
                        if (type === CSSRule.KEYFRAMES_RULE) {
                            ...
                            // to handle local imports on an about:blank page
